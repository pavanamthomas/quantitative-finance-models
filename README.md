...
Identities that admit a known numerical check are tested. `MODEL_RISK_NOTES.md`
records the further limit: a correct implementation of a formula does not
establish that the formula describes a market. Open work is `ROADMAP.md`.
Failures retained on purpose are `docs/failures_and_corrections.md`.
